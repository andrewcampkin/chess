...
public class ChessGame {
	...
	private void loadImages() {
		...
		try {
			// TODO need to figure out getting the files included and using relative paths
	...
	public boolean move(Point firstPoint, Point secondPoint, JTextArea outputArea) {
